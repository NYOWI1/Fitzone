...
function SignUpPage({ clerkEnabled }) {
  return (
    <main className="relative min-h-screen overflow-hidden bg-[#0d0d0d] px-[clamp(28px,5vw,70px)] py-[38px] font-[Inter,Arial,sans-serif] text-white max-[1080px]:overflow-auto max-[640px]:h-[100svh] max-[640px]:min-h-0 max-[640px]:overflow-hidden max-[640px]:p-2">
