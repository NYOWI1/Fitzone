                  ...
                  >
                    <div className="flex min-w-0 items-center gap-3 max-[980px]:col-span-full">
                      <span
                        className={
                          plan.premium
                            ? "h-[42px] w-[42px] flex-[0_0_42px] rounded-2xl bg-[#ffd54f]"
                    ...
                    <span
                      className={
                        plan.badge ? categoryPillClass : mutedPillClass
                      }
                    >
                      {plan.badge || "None"}
                    </span>
              ...
              <section className="admin-card min-h-0">
                ...
                <div
                  className={
                    selectedPlan?.premium
                      ? "mt-[22px] grid gap-2.5 rounded-[18px] border border-[rgba(57,57,57,0.82)] border-t-[5px] border-t-[#ffd54f] bg-[rgba(43,43,43,0.72)] p-[18px]"
                ...
                >
                  <span
                    className={
                      selectedPlan?.premium
                        ? "text-[11px] font-black text-[#ffd54f]"
                        : "text-[11px] font-black text-[#d90429]"
                    }
                  >
                    {selectedPlan?.badge || "MEMBERSHIP"}
                  </span>
          ...
          >
            ...
            <div className="admin-form-grid">
              ...
              <label>
                ...
                <input
                  onChange={(event) =>
                    updatePlanFormValue("badge", event.target.value)
                  }
              ...
              <label className="admin-checkbox-label">
                <input
                  ...
                  onChange={(event) =>
                    updatePlanFormValue("premium", event.target.checked)
                  }
                  type="checkbox"
                />
